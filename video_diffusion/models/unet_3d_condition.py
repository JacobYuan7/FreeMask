...
class UNetPseudo3DConditionModel(ModelMixin, ConfigMixin):
    ...
    def forward(
        ...
        # 5. up
        # print("unet3d.up_blocks: ",len(self.up_blocks)) 4
        for i, upsample_block in enumerate(self.up_blocks):
            # print("upsample_block.resnets: ",upsample_block.resnets)
            # print("len(upsample_block.resnets): ",len(upsample_block.resnets)) 3
